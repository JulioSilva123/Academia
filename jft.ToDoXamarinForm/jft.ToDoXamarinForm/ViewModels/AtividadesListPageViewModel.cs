...
{
    public class AtividadesListPageViewModel : BaseViewModel<Atividades>
    {
        ...
        private Atividades _selectedItem;
        ...
        public Atividades SelectedItem
        {
            get => _selectedItem;
            set
            {
        ...
        async void OnItemSelected(Atividades item)
        {
            if (item == null)
                return;
